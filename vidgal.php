...
<html>
	...
	.dropotron.level-0:before
			{
				...
				border-bottom: solid 10px #7F2B82;
				border-bottom-color: #7F2B82;
			}
		</style>
	...
	<body class="homepage">
		...
		<!-- Main -->
			<div id="main-wrapper" style="background: #AC66AE;">
				<div class="container">
					<div class="row">
						<div class="12u">
							...
							<!-- Events -->
								<section>
									<header class="major">
										...
										<div class="12u">
											<section class="box">
												<a href="#" class="image featured"><img src="images/vid.png" alt="" /></a>
											</section>
										</div>
									</div>
